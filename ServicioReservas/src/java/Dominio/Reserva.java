...
@NamedQueries({
    ...
    @NamedQuery(name = "Reserva.findByFechas", query = "SELECT r FROM Reserva r WHERE r.fechainicioalquiler >= :fechainicioalquiler and r.fechainicioalquiler <= :fechafinalquiler or r.fechafinalquiler>= :fechainicioalquiler and r.fechafinalquiler <= :fechafinalquiler")})
